...
{
	echo('<h4><font color="red">MYSQLi</font> is DISABLE or <font color="red">Database_Start</font> is FALSE , See <font color="green">"database_start"</font> on <font color="red"> "class/index.php"</font> -> (line 66) or (line 71) </br></h4>');
}
